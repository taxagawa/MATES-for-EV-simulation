...
// by uchida 2016/5/23
//======================================================================
const bool Intersection::isCS() const
{
    return _isCS;
}

//======================================================================
string Intersection::charge() const
{
    return AmuConverter::itos((int)(_instantaneousCharge), 6);
}

//======================================================================
double Intersection::charged() const
{
...
void Intersection::renewPassTimeForGlobal()
{
    ...
    {
        _previousPassTimeTotal[i] = _passTimeTotal[i];
        _previousNumPassedVehicleTotal[i] = _numPassedVehicleTotal[i];
    }
...
//======================================================================
void Intersection::setSubNode(Intersection* intersection)
{
    SubNode* ptSubNode = new SubNode(center());
    ptSubNode->setIntersection(intersection);
    _SubNodes.push_back(ptSubNode);

//    print();
}

//======================================================================
vector<SubNode*> Intersection::SubNodes()
{
    return _SubNodes;
}
