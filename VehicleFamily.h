...
public:
    ...
    // EV追加
    static VehicleType EV_passenger();
    static bool isEV_Passenger(VehicleType type);

    static VehicleType EV_ghost();
    static bool isEV_Ghost(VehicleType type);
...
protected:
    ...
    static const VehicleType _EV_passenger   =  8; // EV追加
    static const VehicleType _EV_ghost       =  9; // EVゴースト追加
